...
class AppointmentController extends Controller
{
    ...
    public function filter(Request $request){
        ...
        // CONSULTA PARA SABER QUE DOCTOR CUMPLE CON LA DISPONBILIDAD DE ATENCION TENIENDO EN
        ...
        foreach ($doctor_query as $doctor_q) { 
            ...
            // ARMAMOS UNA LISTA DE DOCTORES CON LOS SEGMENTOS DE SU HORA(MARCAMOS CUALES SE ENCUETRAN OCUPADOS)
            $doctors->push([
                //DATOS DEL DOCTOR
                "doctor"=>[
                ...
                //DATOS DEL SEGMENTO EN UN FORMATO PARA EL FRONTED
